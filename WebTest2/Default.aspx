          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p>New Orders<br />
                       <asp:Button ID="btn_ekle" CssClass="btn btn-block bg-gradient-warning btn-lg" runat="server" Text="Ekle" Width="30%" />
                </p>
              </div>
              <div class="icon">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="/Temp/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="/Temp/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="/Temp/dist/img/user1-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="/Temp/dist/img/user7-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="/Temp/dist/img/user3-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="/Temp/dist/img/user5-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="/Temp/dist/img/user6-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="/Temp/dist/img/user8-128x128.jpg" alt="User Avatar">
